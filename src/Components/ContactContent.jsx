                ...
                <div className="py-8 px-4  max-w-screen-xl lg:py-16 lg:px-6 ">
                    <div className='md:flex gap-3'>
                        ...
                        <div className='flex-1 px-3'>
                            ...
                            <Accordion>
                                <Accordion.Panel>
                                    <Accordion.Title>What type of cuisine does your restaurant offer?</Accordion.Title>
                                    <Accordion.Content>
                                        <p className="mb-2 text-slate-900 ">
                                        We offer [insert type of cuisine,f e.g., Italian, Asian fusion, Mediterranean] cuisine that combines traditional flavors with modern twists.
                                        </p>
                                ...
                                <Accordion.Panel>
                                    <Accordion.Title>Can I make a reservation online?</Accordion.Title>
                                    <Accordion.Content>
                                ...
                                <Accordion.Panel>
                                    <Accordion.Title>Is there a dress code for dining at your restaurant?</Accordion.Title>
                                    <Accordion.Content>
                                        <p className="mb-2 text-gray-800 ">
                                        We offer [insert type of cuisine, e.g., Italian, Asian fusion, Mediterranean] cuisine that combines traditional flavors with modern twists.
                                        </p>
